...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::delete('/v1/category/{category}', [CategoryDeleteControllerV1::class, 'destroy'])->name('categoryv1.destroy');
    Route::put('/v1/category/{category}', [CategoryUpdateControllerV1::class, 'update'])->name('categoryv1.update');
    /* CRUD API END */
});
